...
| Next Action                | Product Foundation slice PF-01 AUTHORIZED NEXT (canonical V2 Activity Product Contract: dual UUID/Activity-Code identity, V2 six+six taxonomy, publication vs Challenge-eligibility separation, versioned history, Push-Up + Breathing Practice exemplars). Engine Baseline Closure slices EBC-01, EBC-02, EBC-03, EBC-04 and PKG-2A remain COMPLETE / MERGED and are NOT reopened. EBC-05 REMAINS UNMERGED: branch `impl/ebc-05-engine-founder-preview-001` (head `d008baa`) is pushed to origin for independent review as technical preview/reference evidence only and must NOT be merged wholesale as the V2 product direction; useful technical pieces may be selectively reused later only where they carry no V1 product semantics. Migrations 007/008/009/010/011/012 remain code-authorized, not deployed. Broad participant/social experience, catalogue browsing UI, Admin CMS, templates and wizard are NOT authorized by PF-01. |                                                                                                                                                                                                                                                                                                                                                    |
...
PF-01 direction note (v1.55, status only — no governance review cycle):
EBC-05 is UNMERGED and is superseded as the next product implementation
direction by the Product Foundation programme (PF-01 first). The EBC-05
branch remains as technical preview/reference evidence; it must not be
merged wholesale. EBC-01 through EBC-04 stay COMPLETE / MERGED and are not
reopened.
