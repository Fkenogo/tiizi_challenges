...
2. **154 exercises** exist in a clean catalogue with rich structure (metrics, units, muscles, breathing, form cues, safety notes, progressions).
3. **10 Wellness categories** are modelled with activities, targets, and frequency.
4. The **single Runtime Catalogue Authority** principle is established (KNW-01).
5. **Fitness and Wellness** are the approved launch domains (EOG-03).
6. Most detailed governance (taxonomy, lifecycle, authority allocation, stewardship) remains **deferred** — these are genuine Stage EK decisions.
7. **No blocking contradictions** exist between the historical knowledge work and current constitutional authority.

**Recommendation:** Proceed with a **single integrated instrument (EKG-01)** covering Knowledge Governance Foundation, Knowledge Asset Identity, Authoritative Meaning, Knowledge Structure/Metrics/Units, Knowledge Change/Integrity, and Knowledge-to-Product Boundary.
...
|---|-----------|--------|-----------------|--------------------------|---------------------------|------------------------------|----------------|-------------------|
| 1 | Exercise (Fitness) | Catalogue (154), Domain Standard | Primary knowledge content | L1 concept defined; instances not classified | YES | YES | YES | YES |
| 2 | Wellness Activity | Templates (10 categories), Domain Standard | Wellness knowledge content | L1 concept defined; instances not classified | YES | YES | YES | YES |
...
| 12 | Wellness Category | Templates (10 categories) | Classification metadata | L4 only | MAYBE | MAYBE | N/A | MAYBE |

**Note:** Items 6–12 are classification metadata that MAY become controlled vocabulary Knowledge Assets or MAY remain as product/discovery metadata. This is a genuine Stage EK decision.
...
- Each exercise declares ONE metric type and ONE default unit
...
The current model is simple: each exercise has one metric. There is no evidence of exercises requiring multiple metrics or metric combinations. This simplicity should be preserved unless governance requires otherwise.
...
|----|----------|-------------------|-------------------|------------------------------|----------------------|
| EK-FQ-01 | Who holds Knowledge Authority? | Assumed platform-level | Not allocated | Founder; delegated authority; Knowledge Council | Cannot approve Knowledge Assets without this |
| EK-FQ-02 | Who is Accountable Steward for Knowledge? | Not addressed | Not allocated (CGP-04 preserves as unallocated) | Founder; designated steward; platform administrator | Knowledge coherence answerability |
| EK-FQ-03 | Are the 154 exercises approved as Knowledge Assets? | Catalogue exists; not formally approved | Domain Standard defines concept; instances not classified | Approve all; approve subset; approve with modifications; defer | Determines the governed knowledge baseline |
| EK-FQ-04 | Are the 10 Wellness categories approved as Knowledge Assets? | Template system exists; not formally approved | Domain Standard defines concept; instances not classified | Approve all; approve subset; approve with modifications; defer | Determines Wellness knowledge baseline |
| EK-FQ-05 | What is the governed metric catalogue? | time:seconds, time:minutes, reps:reps exist | Domain Standard defines Metric concept | Adopt existing three; add more; restructure | Determines measurement governance |
| EK-FQ-06 | What is the governed unit catalogue with conversion rules? | seconds, minutes, reps exist; no conversions | Domain Standard defines Unit concept | Adopt existing; add conversions; add units | Determines unit governance |
| EK-FQ-07 | What is the knowledge lifecycle model? | Draft→review→publish→change→deprecate→archive proposed | KNW-02/KNW-03 deferred | Adopt proposed; simplify; extend | Determines how knowledge changes over time |
| EK-FQ-08 | What taxonomy/content classification is controlled? | Body categories, muscles, goals, tags exist as L4 | Not governed | Adopt existing categories; restructure; defer | Determines discovery/filtering governance |
| EK-FQ-09 | What is the exercise family dictionary? | Families proposed in corpus | Concept incorporated; dictionary deferred | Adopt proposed families; restructure; defer | Determines exercise grouping |
| EK-FQ-10 | What Wellness rationalisation decisions apply? | Rationalisation matrix proposed | Not decided | Keep/merge/variant/reclassify/retire per matrix | Determines Wellness knowledge baseline |
| EK-FQ-11 | What is the Knowledge Asset record specification? | Rich structure demonstrated | Not mandated | Adopt rich model; minimal model; tiered model | Determines mandatory content requirements |
| EK-FQ-12 | How does the Runtime Catalogue become available for participation? | Seed data / Firestore | KNW-01 principle; mechanism deferred | Governed publication; automated pipeline; manual approval | Determines runtime availability governance |
...
**The Founder/ChatGPT should commence EKG-01 drafting, addressing the Founder Decision Register (EK-FQ-01 through EK-FQ-12) in dependency order:**

1. **EK-FQ-01** (Knowledge Authority holder) — prerequisite for all other decisions
2. **EK-FQ-02** (Accountable Steward) — prerequisite for lifecycle and change governance
3. **EK-FQ-03/04** (Exercise/Wellness Asset approval) — establishes the knowledge baseline
4. **EK-FQ-05/06** (Metric/Unit catalogues) — governs measurement
5. **EK-FQ-07** (Lifecycle model) — governs knowledge change
6. **EK-FQ-08/09** (Taxonomy/families) — governs classification
7. **EK-FQ-10** (Wellness rationalisation) — governs Wellness content
8. **EK-FQ-11** (Record specification) — governs content requirements
9. **EK-FQ-12** (Runtime Catalogue mechanism) — governs availability

---

_This is the Stage EK Knowledge Foundation Audit and Carry-Forward Assessment. It confirms that Stage EK has a substantial existing foundation to build upon, identifies 10 genuine Stage EK gaps requiring Founder decisions, and recommends a single integrated EKG-01 instrument._
