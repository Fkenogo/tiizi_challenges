...
**Version:** Approved constitutional inventory baseline — CG-08 amendment applied

**Status:** Approved constitutional inventory governance

**Date:** 2026-07-20

**Approval date:** 2026-07-21

**Approval authority:** Founder, exercising Governance Authority

**Amendment date:** 2026-07-21

**Amendment authority:** Founder

**Amendment record:** [EOG-05 CG-08 Constitutional Amendment](36-EOG-05-CG-08-CONSTITUTIONAL-AMENDMENT.md)
...
This is Founder Review Draft 2. Its classifications are recommendations, not approved Entity Ownership governance.

The draft applies the [approved separated-register architecture](23-EOG-05-ARCHITECTURE-APPROVAL-RECORD.md) and the [Drafting Authorization Report](23-EOG-05-INVENTORY-REGISTER-DRAFTING-AUTHORIZATION-REPORT.md). It assesses all 72 Phase 0 candidates. Following the attributable CG-08 amendment, it records 58 as Proposed inclusion on source-grounded treatment, preserves 13 as Provisional under CG-01 through CG-07, and preserves Recognition as one additional Provisional candidate pending MOT-01.
...
| AMD-CG08 | [EOG-05 CG-08 Constitutional Amendment](36-EOG-05-CG-08-CONSTITUTIONAL-AMENDMENT.md) and [Founder Approval Package](36-EOG-05-CG-08-FOUNDER-APPROVAL-PACKAGE.md) |
...
5. **Provisional means unresolved.** A provisional Entity ID supports review and traceability only. It does not approve permanent row treatment. Provisional treatment may be controlled by a classification gate or a named later governance decision.
...
| GRP-02 | Membership relationship | — | Group | Independent governed relationship | The Person–Group relationship | The governed relationship connecting a Person to a Group as a Member. | GRP-02 is the governed relationship; GRP-03 identifies the Person-in-context. Membership is not Profile ownership, Challenge participation or governance. | Participation Information | Proposed inclusion | E2; E4; DOM; GRP-03; later Membership standard; RR-03 |
| GRP-03 | Member | — | Group | Independent Person-in-context designation; entity-versus-context test passed for Draft 2 | The Person as contextually designated through one Membership relationship | The governed designation of a Person within a particular Group membership relationship. | Member identifies the Person-in-context; GRP-02 remains the relationship itself. Neither row substitutes for the other, and membership grants no implied governance relationship. | Participation Information | Proposed inclusion | E2; E4; DOM; RR-03 |
...
| C-GRP-08 | Group Governance Body | Stewardship Council | Group | Independent supporting governed-body subject | Information about a Governance Body primarily concerns that body where established. Information about its Group remains information about the Group. Information about a separately governed relationship remains information about that relationship and its relevant subjects. | An optional governed body that a Group may establish to support its constitutional governance while preserving the singular Accountable Steward relationship. A Group may establish one or more such bodies and may determine their operational titles. | Governance Body membership or responsibility is not Accountable Stewardship, Authority, Administration or Custody. Constitutional recognition neither requires a Group to establish a body nor limits a Group to one body. | Participation Information | Proposed inclusion | E2; AMD-CG08; future Group Governance Body governance |
...
| CHL-04 | Challenge Policy | — | Challenge | Challenge-scoped Policy instance; not a separate Policy class | The identified Policy and its declared Challenge scope | A governed Policy instance whose declared scope supplies rules to a particular Challenge. | CHL-04 is a scoped instance within CTL-01 Policy treatment. “Applicable” describes the Policy's contextual use and does not create another entity. Challenge scope remains distinct from Knowledge, Group configuration and Challenge identity. | Knowledge Information | Proposed inclusion | E3; E4; DOM; CTL-01; later Policy governance; RR-05 |
| CHL-05 | Challenge participation relationship | — | Challenge | Independent governed relationship | The governed relation connecting a Person to one Challenge | The Challenge-specific relationship through which a Person participates in Group context. | This row governs the relationship itself; CHL-06 identifies the Person-in-context. Membership does not establish either, and participation is not governance. | Participation Information | Proposed inclusion | E1; E2; E4; DOM; later Participation standard; RR-03 |
| CHL-06 | Participant | — | Challenge | Independent Person-in-context designation; entity-versus-context test passed for Draft 2 | The Person as contextually designated through one Challenge participation relationship | The governed designation of a Person within a particular Challenge participation relationship. | Participant identifies the Person-in-context; CHL-05 remains the relationship itself. Neither row substitutes for the other, and the designation grants no authority over other Participants. | Participation Information | Proposed inclusion | E1; E4; DOM; RR-03 |
...
| C-CHL-09 | Group Configuration | — | Challenge composition | Candidate composition input; independent-subject treatment unresolved | Unresolved — whether information primarily concerns Group, Challenge, or an independent composition object remains subject to CG-02 | Governed Group-supplied configuration used in Constitutional Composition. | It is not Platform Knowledge, Policy or the resulting Challenge. | Participation Information | Provisional — CG-02 | E3; E4; P0; CHL and GRP dependencies |
| C-CHL-10 | Community Context | — | Challenge composition | Candidate contextual input; independent-subject treatment unresolved | Unresolved — whether information primarily concerns Group, Challenge, or an independent contextual object remains subject to CG-02 | Governed local context contributed by a Group to the meaning of a composed experience. | Community Context cannot redefine Platform Knowledge or applicable Policy. | Participation Information | Provisional — CG-02 | E3; E4; P0; CHL and GRP dependencies |

### 6.4 Activity, Evidence and Event

| Entity ID | Canonical name | Approved alias | Domain | Governed Subject classification | Information Subject treatment | Constitutional definition | Principal boundary | Primary category | Classification status | Sources and dependency |
|---|---|---|---|---|---|---|---|---|---|---|
| AEV-01 | Activity | — | Knowledge and Activity Event | Independent governed concept | The canonical Activity concept whose meaning is borne by an Activity Knowledge Asset | A governed concept of measurable action or occurrence available for declared use. | Activity is the concept; KNW-02 is the identifiable meaning-bearing Knowledge Asset. Neither is an occurrence or Activity Event, and neither row duplicates the other. | Knowledge Information | Proposed inclusion | E3; E4; DOM; KNW-02; RR-04 |
| AEV-02 | Metric | — | Knowledge and Activity Event | Independent governed concept | The canonical Metric concept whose meaning is borne by a Metric Knowledge Asset | A governed measurement dimension by which an Activity or outcome may be measured. | Metric is the concept; KNW-03 is the identifiable meaning-bearing Knowledge Asset. Metric is not Unit, measured value, score or formula. | Knowledge Information | Proposed inclusion | E3; E4; DOM; KNW-03; RR-04 |
| AEV-03 | Unit | — | Knowledge and Activity Event | Independent governed concept | The canonical Unit concept whose meaning is borne by a Unit Knowledge Asset | A governed expression of measurement used with an approved Metric. | Unit is the concept; KNW-04 is the identifiable meaning-bearing Knowledge Asset. A display label cannot substitute for Unit meaning. | Knowledge Information | Proposed inclusion | E3; E4; DOM; KNW-04; RR-04 |
...
| AEV-08 | Verification | — | Activity Event | Independent governed concept; detailed subject meaning unresolved | Unresolved — whether Verification information primarily concerns a claim, Accepted Activity Event, evidence use, or another governed matter remains subject to ACT-03 | A governed determination concerning evidential status whose exact meaning and effect remain deferred. | Verification is not Submission Intent, acceptance, eligibility or calculation by implication. | Activity Information | Proposed inclusion | E4; DATA; DOM; ACT-03 |
...
| DRV-09 | Recognition | — | Motivation | Candidate acknowledgement subject; derived treatment unresolved | Proposed — the participation, Group contribution, Completion, Ranking, consistency, or other governed outcome that later Recognition governance may permit to be acknowledged | A candidate truthful acknowledgement whose constitutional qualification and relationship to Derived Information remain unresolved. | “Derived acknowledgement” is provisional only. Recognition is not evidence, Ranking, Reward or Presentation alone, and no qualifying truth is approved here. | Derived Information — provisional pending MOT-01 | Provisional — MOT-01 | E4; DATA; DOM; MOT-01; RR-02 |
...
| KNW-02 | Activity Knowledge Asset | — | Knowledge Asset | Independent meaning-bearing asset subject | The identifiable Knowledge Asset bearing the meaning of an Activity concept | A Knowledge Asset that bears, preserves and communicates reusable Activity meaning for declared domains. | The asset bears the meaning of AEV-01 but is not the Activity concept itself. Generic treatment must not duplicate Exercise or Wellness Activity Asset identity. | Knowledge Information | Proposed inclusion | E3; DOM; AEV-01; CG-04 impact remains; RR-04 |
| KNW-03 | Metric Knowledge Asset | — | Knowledge Asset | Independent meaning-bearing asset subject | The identifiable Knowledge Asset bearing the meaning of a Metric concept | A Knowledge Asset that bears, preserves and communicates reusable Metric meaning. | The asset bears the meaning of AEV-02 but is not the Metric concept, a measured value, formula or score. | Knowledge Information | Proposed inclusion | E3; DOM; AEV-02; KNW classification governance; RR-04 |
| KNW-04 | Unit Knowledge Asset | — | Knowledge Asset | Independent meaning-bearing asset subject | The identifiable Knowledge Asset bearing the meaning of a Unit concept | A Knowledge Asset that bears, preserves and communicates reusable Unit meaning. | The asset bears the meaning of AEV-03 but is not the Unit concept, a display label or measured value. | Knowledge Information | Proposed inclusion | E3; DOM; AEV-03; KNW classification governance; RR-04 |
...
| KNW-09 | Runtime Catalogue | — | Runtime Knowledge | Candidate governed function; independent-subject treatment unresolved | Unresolved — whether catalogue information concerns the governed function, runtime-availability facts, or another admitted entity remains subject to CG-03 | The single governed function through which approved Knowledge is made available for declared runtime use. | Runtime Catalogue is not a Platform Authority, actor, role or source of canonical meaning. | Knowledge Information | Provisional — CG-03 | E3; P0; KNW-01 and later Runtime governance |
...
| Entity ID | Canonical name | Approved alias | Domain | Governed Subject classification | Information Subject treatment | Constitutional definition | Principal boundary | Primary category | Classification status | Sources and dependency |
|---|---|---|---|---|---|---|---|---|---|---|
| CTL-01 | Policy | — | Cross-platform governance | Canonical policy class and independent policy subject | The governed rule, declared scope and affected subjects | An approved rule governing permitted behavior, evidence use, calculations, access or administrative action for a declared purpose. | CHL-04 Challenge Policy is a Challenge-scoped instance within this class. Applicable Policy describes contextual use and creates no second Policy entity. Policy is not Knowledge, evidence, calculation or presentation. | Knowledge Information | Proposed inclusion | E3; E4; DATA; CHL-04; future Policy governance; RR-05 |
...
| C-CTL-07 | Creation Mechanism | — | Challenge composition | Candidate governed mechanism; entity-versus-capability treatment unresolved | Unresolved — whether information concerns a mechanism, governed capability, composition context, or no independent entity remains subject to CG-07 | A governed means that consumes Platform Knowledge, Templates and Group configuration to produce a Group Challenge. | It is not a Knowledge Asset, Challenge, Platform Authority or source of Policy applicability. | Presentation Information | Provisional — CG-07 | E3; E4; P0; future Creation governance |
...
| Provisional — classification gates | 13 | Permanent entity or row treatment remains open under CG-01 through CG-07. |
| Provisional — later governance | 1 | Recognition category and derived-acknowledgement treatment remain open under MOT-01. |
...
| Derived Information | 6 (including 1 provisional) |
...
CG-01 through CG-07 remain unresolved.

### Resolved classification gate

| Gate | Entity ID | Resolution |
|---|---|---|
| CG-08 | C-GRP-08 | Resolved by the [founder-approved EOG-05 CG-08 amendment](36-EOG-05-CG-08-CONSTITUTIONAL-AMENDMENT.md). Group Governance Body has permanent independent inventory treatment. The resolution allocates no EOG-01 relationship and preserves separate treatment for Group Information, Governance Body Information and Relationship Information. |
...
| Member / Membership relationship | Member identifies the Person-in-context; Membership relationship identifies the governed relation itself. Neither substitutes for the other. |
| Participant / Challenge participation relationship | Participant identifies the Person-in-context; Challenge participation relationship identifies the governed relation itself. Neither substitutes for the other. |
| Activity / Activity Knowledge Asset | Activity is the governed concept; Activity Knowledge Asset is the identifiable asset bearing its meaning. |
| Metric / Metric Knowledge Asset | Metric is the governed concept; Metric Knowledge Asset is the identifiable asset bearing its meaning. |
| Unit / Unit Knowledge Asset | Unit is the governed concept; Unit Knowledge Asset is the identifiable asset bearing its meaning. |
| Challenge Policy / Policy | Challenge Policy is a Challenge-scoped Policy instance; Policy remains the canonical class, and applicability creates no second entity. |
...
- **GRP:** Group identity is retained; Group purpose remains Provisional where named. Group Governance Body has permanent independent inventory treatment where a Group chooses to establish one or more such bodies. This treatment does not require a body, prescribe its operational title or allocate any relationship.
...
3. the 13 classification-gate candidates remain restrained under CG-01 through CG-07, and Recognition remains additionally provisional under MOT-01;
...
**Approved constitutional inventory baseline.** Structurally complete for the 72-candidate audit universe and approved as constitutional inventory governance.

The founder-approved CG-08 amendment is applied. It establishes permanent constitutional inventory recognition for C-GRP-08 Group Governance Body while preserving progressive Group governance: each Group chooses whether and when to establish one or more governance bodies and may determine their operational titles. The singular Accountable Steward relationship remains unchanged.
